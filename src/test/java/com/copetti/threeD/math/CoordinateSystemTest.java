...
public class CoordinateSystemTest
{
	...
	{
		PolarCoordinate p = new PolarCoordinate(1.0f, Angle.fromDegree(90.f));
	...
	{
		PolarCoordinate p = new PolarCoordinate(1.0f, Angle.fromDegree(180.f));
	...
	{
		PolarCoordinate p = new PolarCoordinate(5.0f, Angle.fromDegree(60.f));
